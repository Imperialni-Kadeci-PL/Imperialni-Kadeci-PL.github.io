...
Relic delta obecnie wyglada tak:

| Relic Delta (Attacker Relic − Defender Relic) | Outgoing Damage Modifier |
| --------------------------------------------- | ------------------------ |
| -5                                            | -60%                     |
| -4                                            | -40%                     |
| -3                                            | -25%                     |
...
Interpretacja tabeli taka ze postac r3 kontra postac r8 dostaje 150% wiecej obrazen i zadaje o 60% mniej.
